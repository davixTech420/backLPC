...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-10-2024 a las 01:35:40
...
(2, 35, NULL, 'logistica', '2024-10-23 23:26:16', '2024-10-23 23:26:16');
...
(1, 13, 3, 'Hola, te saludo estoy interesado en tu Teatro Camarin Del Carmen', '2024-10-23', 0, '2024-10-23 14:10:40', '2024-10-23 14:10:40');
...
(4, 5, 8, 'pendiente', 0, '0', '2024-10-23 14:10:07', '2024-10-23 14:10:07');
...
(5, '/images/1729692607652-porellas.jpg', 'por ellas lo qu', 250, '2024-10-26', '10:08:00', '11:08:00', 1, 8, 13, '2024-10-23 14:10:07', '2024-10-23 22:06:01');
...
(35, 'asd', 'asd', 'C.C', '1312321321', '3154656456', 'asd@sad.sd', '$2a$10$xAq.PBiz9BNq08Lqu.QKwuuSyeCd0mHglaHnLao9vh/YmiMsxXliC', 1, 'empleado', '2024-10-23 13:23:42', '2024-10-23 23:26:16');
...
ALTER TABLE `shows`
  ...
  ADD CONSTRAINT `shows_ibfk_3` FOREIGN KEY (`salaId`) REFERENCES `salas` (`id`),
  ADD CONSTRAINT `shows_ibfk_4` FOREIGN KEY (`clienteId`) REFERENCES `users` (`id`);
COMMIT;
